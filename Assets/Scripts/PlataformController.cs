...
public class PlataformController : RaycastController
{
    ...
    void MovePassengers(bool beforeMovePlataform)
    {
        foreach (PassengerMovement passenger in passengerMovement)
        {
            ...
            {
                passengerDictionary[passenger.transform].Move(passenger.velocity, passenger.standingOnPlataform);
            } 
        }
    }
    ...
    void CalculatePassengerMovement(Vector3 velocity)
    {
        ...
        //Mover Horizontal la plataforma
        if( velocity.x != 0 )
        {
        ...
        //Pasajero de la plataforma Horizontal
        if (directionX == -1 || velocity.y == 0 && velocity.x != 0) 
        {
    ...
    struct PassengerMovement
    {
        ...
        public bool standingOnPlataform;
        public bool moveBeforeplataform;

        public PassengerMovement(Transform _transform,  Vector3 _velocity, bool _standingOnPlataform, bool _moveBeforeplataform)
        {
            transform = _transform;
            velocity = _velocity;
            standingOnPlataform = _standingOnPlataform;
